...
var ASM_CONSTS = {
  4592608: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4592669: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4592733: function() {return Module.webglContextAttributes.powerPreference;},  
 4592791: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4592846: function($0) {performance.now = function() { return $0; };},  
 4592894: function($0) {performance.now = function() { return $0; };},  
 4592942: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _FMCaptureMicStart_2021_2(_callbackID, _callback)
      {
  ...
  function _FMCoreTools_WebGLAddScript_2021_2(_innerHTML, _src, _id, _onload)
      {
  ...
  function _FMStopMicStream()
      {
        if (MicRecorder != null) MicRecorder.disconnect();
        MicRecording = false;
      }

  function _FMUnzipBytesJSAsync(_array, _size, _callbackID, _callback)
      {
  ...
  function _FMWebSocket_AddEventListeners_2021_2(_src, _gameobject)
    // FMWebSocket_AddEventListeners_2021_2: function (_src, _gameobject, _callbackID, _callback)
    {
      var src = UTF8ToString(_src);
      var gameobject = UTF8ToString(_gameobject);
      ...
      function onOpen(evt)
      {
        ...
        {
          //_globalCallback, _callbackID, string, outputlength, outputPtr
          //
          // Module.dynCall_viii(_callback, _callbackID, 'RegOnOpen', 0, 0);
  ...
  function _FMWebSocket_Close_2021_2(_e, _data)
    {
      if(websocket === null) return;
      if(websocket.readyState === WebSocket.OPEN) websocket.close();
    }

  function _FMWebSocket_IsWebSocketConnected_2021_2()
    {
      var returnStr = "-1";
      if(websocket !== null)
      {
  ...
  function _FMWebSocket_SendByte_2021_2(_array, _size)
    {
      const newArray = new ArrayBuffer(_size);
      const newByteArray = new Uint8Array(newArray);
      for(var i = 0; i < _size; i++) newByteArray[i] = HEAPU8[_array + i];
  ...
  function _FMWebSocket_SendString_2021_2(_src)
    {
  ...
  function _StreamAudio(NUM_LABEL, NUM_CHANNELS, NUM_SAMPLES, SAMPLE_RATE, _array, _size)
      {
...
var asmLibraryArg = {
  "FMCaptureMicStart_2021_2": _FMCaptureMicStart_2021_2,
  "FMCoreTools_WebGLAddScript_2021_2": _FMCoreTools_WebGLAddScript_2021_2,
  "FMStopMicStream": _FMStopMicStream,
  "FMUnzipBytesJSAsync": _FMUnzipBytesJSAsync,
  "FMWebSocket_AddEventListeners_2021_2": _FMWebSocket_AddEventListeners_2021_2,
  "FMWebSocket_Close_2021_2": _FMWebSocket_Close_2021_2,
  "FMWebSocket_IsWebSocketConnected_2021_2": _FMWebSocket_IsWebSocketConnected_2021_2,
  "FMWebSocket_SendByte_2021_2": _FMWebSocket_SendByte_2021_2,
  "FMWebSocket_SendString_2021_2": _FMWebSocket_SendString_2021_2,
...
/** @type {function(...*):?} */
var dynCall_iiiiifiiiffiiiii = Module["dynCall_iiiiifiiiffiiiii"] = createExportWrapper("dynCall_iiiiifiiiffiiiii");

/** @type {function(...*):?} */
var dynCall_iiiiifiiii = Module["dynCall_iiiiifiiii"] = createExportWrapper("dynCall_iiiiifiiii");

/** @type {function(...*):?} */
var dynCall_iiiiiiiiiiiffffiiiifiiiiiiiiiiiiii = Module["dynCall_iiiiiiiiiiiffffiiiifiiiiiiiiiiiiii"] = createExportWrapper("dynCall_iiiiiiiiiiiffffiiiifiiiiiiiiiiiiii");
